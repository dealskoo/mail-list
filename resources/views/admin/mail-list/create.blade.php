...
@section('title',__('mail-list::mail-list.add_mail'))
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">{{ __('mail-list::mail-list.add_mail') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.mail-lists.store') }}" method="post">
                        @csrf
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="first_name" name="first_name"
                                           value="{{ old('first_name') }}" autofocus tabindex="1"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control date" id="email_verified_at"
                                           ...
                                           data-toggle="date-picker" value="{{ old('email_verified_at') }}" tabindex="4"
