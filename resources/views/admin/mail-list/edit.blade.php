                    ...
                    <form action="{{ route('admin.mail-lists.update', $email) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="email"
                                        class="form-label">{{ __('mail-list::mail-list.email') }}</label>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control date" id="email_verified_at"
                                        name="email_verified_at" data-single-date-picker="true" data-toggle="date-picker"
                                        value="{{ old('email_verified_at', $email->email_verified_at->format('m/d/Y')) }}"
                                        tabindex="4"
